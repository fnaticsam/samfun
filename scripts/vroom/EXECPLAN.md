...
- [x] 2026-07-22 Body-icon artwork: replaced the nine generated inline SVG picker drawings with the user's original transparent 1024px PNG files, copied byte-for-byte and visually mapped to Hatchback, Saloon, Estate, SUV, Coupé, Convertible, MPV, Van and Pick-up without changing filter semantics.
